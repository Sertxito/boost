...
La especificación debe guardarse en el directorio [/spec/](/spec/) y nombrarse según la siguiente convención: `spec-[a-z0-9-]+.md`, donde el nombre debe describir el contenido y comenzar con el propósito de alto nivel, que debe ser uno de [schema, tool, data, infrastructure, process, architecture, or design].
