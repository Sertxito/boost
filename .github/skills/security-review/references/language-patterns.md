...
Carga la seccion relevante durante el Paso 1 (resolucion de alcance) tras identificar los lenguajes.

---

## JavaScript / TypeScript (Node.js, React, Next.js, Express)

### APIs/llamadas criticas para marcar
```js
