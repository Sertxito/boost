# Formato del reporte de seguridad

<!-- markdownlint-disable-file -->

Usa esta plantilla para toda salida de `/security-review`. Se genera durante el Paso 7.
...
Muestra esto siempre primero — vista general rapida:
...
Para CADA hallazgo, usa este formato de tarjeta:
...
### Seccion de auditoria de dependencias
...
### Seccion de escaneo de secretos
...
### Seccion de propuestas de parche

Incluir solo para hallazgos CRITICAL y HIGH:
...
## Guia de niveles de confianza

Aplicar a cada hallazgo:

| Confianza | Cuando usarla |
|------------|-------------|
| **HIGH** | La vulnerabilidad es inequivoca. Falta sanitizacion de forma clara. Explotable tal cual. |
| **MEDIUM** | La vulnerabilidad probablemente existe, pero depende del contexto de ejecucion, configuracion o flujo que el agente no pudo trazar completamente. |
| **LOW** | Se detecto un patron sospechoso, pero podria ser falso positivo. Marcar para revision humana. |

Nunca omitas la confianza — ayuda a priorizar el esfuerzo de revision.
