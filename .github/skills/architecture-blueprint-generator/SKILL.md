...
description: 'Generador integral de blueprint de arquitectura de proyecto que analiza codebases para crear documentación arquitectónica detallada. Detecta automáticamente stacks tecnológicos y patrones de arquitectura, genera diagramas visuales, documenta patrones de implementación y provee blueprints extensibles para mantener consistencia arquitectónica y guiar nuevo desarrollo.'
---

# Generador integral de blueprint de arquitectura de proyecto

## Variables de configuracion
${PROJECT_TYPE="Auto-detect|.NET|Java|React|Angular|Python|Node.js|Flutter|Other"} <!-- Tecnologia principal -->
${ARCHITECTURE_PATTERN="Auto-detect|Clean Architecture|Microservices|Layered|MVVM|MVC|Hexagonal|Event-Driven|Serverless|Monolithic|Other"} <!-- Patron arquitectonico principal -->
${DIAGRAM_TYPE="C4|UML|Flow|Component|None"} <!-- Tipo de diagrama de arquitectura -->
${DETAIL_LEVEL="High-level|Detailed|Comprehensive|Implementation-Ready"} <!-- Nivel de detalle a incluir -->
${INCLUDES_CODE_EXAMPLES=true|false} <!-- Incluir ejemplos de codigo para ilustrar patrones -->
${INCLUDES_IMPLEMENTATION_PATTERNS=true|false} <!-- Incluir patrones detallados de implementacion -->
${INCLUDES_DECISION_RECORDS=true|false} <!-- Incluir registros de decisiones de arquitectura -->
${FOCUS_ON_EXTENSIBILITY=true|false} <!-- Enfatizar puntos de extension y patrones -->

## Prompt generado

"Crea un documento integral 'Project_Architecture_Blueprint.md' que analice en profundidad los patrones arquitectónicos del codebase para servir como referencia definitiva en el mantenimiento de la consistencia arquitectónica. Usa el siguiente enfoque:
...
- Resumen arquitectonico de alto nivel que muestre los subsistemas principales
