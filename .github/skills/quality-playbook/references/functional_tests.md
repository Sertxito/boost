# Redaccion de pruebas funcionales

<!-- markdownlint-disable-file -->

Este es el entregable mas importante. Los archivos Markdown son documentacion. El archivo de pruebas funcionales es la red de seguridad automatizada. Nombralo siguiendo las convenciones del proyecto: `test_functional.py` (Python/pytest), `FunctionalSpec.scala` (Scala/ScalaTest), `FunctionalTest.java` (Java/JUnit), `functional.test.ts` (TypeScript/Jest), `functional_test.go` (Go), etc.

## Estructura: tres grupos de pruebas
...
## Heuristica de conteo de pruebas
...
## Patron de importacion: igualar las pruebas existentes
...
## Crear setup de pruebas ANTES de escribir tests
...
## Leer antes de escribir: mapa de llamadas de funciones
...
## Redaccion de pruebas derivadas de especificacion
...
## Que hace buena a una prueba funcional
...
## Estrategia de pruebas cross-variant
...
### Anti-patron de captura de excepciones en detalle
...
## Pruebas de escenarios fitness-to-purpose
