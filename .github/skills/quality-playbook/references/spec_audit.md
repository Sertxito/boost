# Protocolo de auditoria de especificaciones Council of Three (Archivo 5)

<!-- markdownlint-disable-file -->

Este es un protocolo de analisis estatico: los modelos de IA leen el codigo y lo comparan con las especificaciones. No se ejecuta codigo. Detecta una clase de problemas distinta al testing: divergencias spec-codigo, funcionalidades no documentadas, specs fantasma e implementaciones faltantes.
...
## Consejos para redactar areas de escrutinio
