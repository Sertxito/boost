# Protocolos de revision (archivos 3 y 4)

<!-- markdownlint-disable-file -->

## Archivo 3: Protocolo de code review (`RUN_CODE_REVIEW.md`)
...
### Fase 2: Pruebas de regresion para bugs confirmados

Después de que la revisión de código produzca hallazgos, escribe pruebas de regresión que reproduzcan cada hallazgo marcado como BUG. Esto transforma la revisión de "aquí hay bugs potenciales" en "aquí hay bugs demostrados con tests fallando".

**Por que esto importa:** Un hallazgo de code review sin un reproductor es una opinion. Un hallazgo con una prueba fallando es un hecho. En multiples codebases (Go, Rust, Python), las pruebas de regresion escritas desde hallazgos de code review han confirmado bugs en alta proporcion, incluyendo data races, fugas de datos entre tenants, violaciones de maquinas de estado y perdida silenciosa de contexto. Ademas, estas pruebas de regresion sirven como criterio de aceptacion para corregir bugs: cuando la prueba pasa, el bug esta corregido.

**Como generar pruebas de regresion:**
...
5. **Si una prueba pasa inesperadamente**, investiga: o bien el hallazgo era un falso positivo, o la prueba no ejerce el camino correcto. Reportalo como NEEDS INVESTIGATION, no como bug confirmado.

**Consejos por lenguaje:**
...
Estos cuatro guardrails suelen mejorar la calidad de revision de codigo de IA al reducir hallazgos vagos o alucinados:
...
La regla de "no cambios de estilo" mantiene las revisiones enfocadas en correccion. Las sugerencias de estilo diluyen la señal y desperdician tiempo de revision.

---

## Archivo 4: Protocolo de pruebas de integracion (`RUN_INTEGRATION_TESTS.md`)
...
Las ejecuciones secuenciales de integracion desperdician tiempo. Agrupa ejecuciones para que las independientes corran en paralelo, con estas restricciones:
...
### Derivar quality gates desde el codigo
...
### Profundidad de verificacion post-ejecucion
