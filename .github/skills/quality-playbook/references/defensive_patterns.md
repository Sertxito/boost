# Encontrar patrones defensivos (Paso 5)

<!-- markdownlint-disable-file -->

Los patrones de codigo defensivo son evidencia de fallos pasados o riesgos conocidos. Cada guard de nulos, try/catch, funcion de normalizacion y comprobacion de centinelas existe porque algo salio mal, o porque alguien anticipo que podia salir mal. Tu trabajo es encontrar estos patrones de forma sistematica y convertirlos en escenarios fitness-to-purpose y pruebas de frontera.
...
## Convertir hallazgos en escenarios
...
## Convertir hallazgos en pruebas de frontera
...
## Patrones de maquinas de estado
...
## Patrones de salvaguardas faltantes
