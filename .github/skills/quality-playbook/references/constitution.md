# Redaccion de la constitucion de calidad (Archivo 1: QUALITY.md)

<!-- markdownlint-disable-file -->

La constitucion de calidad define que significa "calidad" para este proyecto concreto y hace que el estandar sea explicito, persistente y heredado por cada sesion de IA.
...
### Fuente 1: Patrones de codigo defensivo (exploracion de codigo)
...
### Fuente 2: Que puede salir mal (conocimiento de dominio)
...
## Calibrar el numero de escenarios
...
## Auto-critica antes de terminar
