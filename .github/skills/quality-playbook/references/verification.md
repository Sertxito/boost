# Checklist de verificacion (Fase 3)

<!-- markdownlint-disable-file -->

Antes de declarar completo el quality playbook, verifica cada benchmark de abajo. Si alguno falla, vuelve y corrigelo.

## Benchmarks de auto-chequeo
...
### 4. Conteo de pruebas de frontera y negativas
...
### 8. Todas las pruebas pasan: cero fallos Y cero errores
...
### 9. Pruebas existentes sin romper
...
### 10. Los escenarios de QUALITY.md referencian codigo real y etiquetan fuentes
...
### 11. RUN_CODE_REVIEW.md es autocontenido
...
### 12. RUN_INTEGRATION_TESTS.md es ejecutable y preciso en campos
...
### 13. El prompt de RUN_SPEC_AUDIT.md es copiable y pegable
...
## Formato de checklist rapido

Usa esto como validacion final:
