...
description: 'Generador de instrucciones de migración y evolución de código para GitHub Copilot. Analiza diferencias entre dos versiones del proyecto (ramas, commits o releases) para crear instrucciones precisas que permitan a Copilot mantener consistencia durante migraciones tecnológicas, refactors mayores o upgrades de framework.'
---

# Generador de instrucciones de migracion y evolucion de codigo
...
### Migracion de version de framework
...
### Evolucion del stack tecnologico  
...
### Modernizacion de patrones de diseno
