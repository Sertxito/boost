...
### Instrucciones de documentación de flujos

Para cada uno de los `${WORKFLOW_COUNT}` workflow(s) más representativos del sistema:
...
#### 3. Implementación de la capa de servicios
...
#### 5. Implementación de acceso a datos
...
#### 8. Patrones de procesamiento asíncrono
...
#### 12. Plantillas de implementación
...
### Patrones de implementacion especificos por tecnologia
