...
Reglas integrales de seguridad para el desarrollo de aplicaciones web. Cada anti‑patrón incluye una clasificación de severidad, método de detección, referencia OWASP 2025 y ejemplos de código correctivo.

**Niveles de severidad:**

- **CRITICAL** — Vulnerabilidad explotable. Debe corregirse antes del merge.
- **IMPORTANT** — Riesgo significativo. Debe corregirse en el mismo sprint.
- **SUGGESTION** — Mejora de defensa en profundidad. Planificar para una iteración futura.

---

## Referencia rápida de OWASP Top 10 — 2025
...
## Plantilla de cabeceras de seguridad
...
## Lista de verificación de validación JWT
