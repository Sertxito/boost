...
Reglas integrales de rendimiento para el desarrollo de aplicaciones web. Cada anti‑patrón incluye una clasificación de severidad, método de detección, métrica de Core Web Vitals impactada y ejemplos de código correctivo.

**Niveles de severidad:**

- **CRITICAL** — Degrada directamente una Core Web Vital más allá del umbral de "poor". Debe corregirse antes del merge.
- **IMPORTANT** — Impacta de forma medible la experiencia de usuario. Corregir en el mismo sprint.
- **SUGGESTION** — Oportunidad de optimización. Planificar para una iteración futura.

---

## Referencia rápida de Core Web Vitals
...
> **Herramienta de diagnóstico:** Usa la API Long Animation Frames (LoAF) (Chrome 123+) para depurar problemas de INP. LoAF ofrece mejor atribución que la API heredada Long Tasks, incluyendo origen del script y tiempo de renderizado.
...
## Referencia rápida de Resource Hints
...
## Referencia rápida de optimización de imágenes
...
## Referencia rápida de carga de fuentes
...
Reglas: precarga solo 1-2 fuentes críticas, usa WOFF2, crea subconjuntos según los caracteres necesarios y autoalójalas cuando sea posible.

---

## Lista de verificación de rendimiento (CWV)
