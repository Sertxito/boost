...
Reglas integrales de accesibilidad para el desarrollo de aplicaciones web. Cada anti‑patrón incluye una clasificación de severidad, método de detección, referencia WCAG 2.2 y ejemplos de código correctivo.

**Niveles de severidad:**

- **CRITICAL** — Las personas usuarias no pueden acceder al contenido en absoluto. Debe corregirse antes del merge.
- **IMPORTANT** — Barrera significativa para personas que usan tecnologías de asistencia. Corregir en el mismo sprint.
- **SUGGESTION** — Mejora la usabilidad para tecnologías de asistencia. Planificar para una iteración futura.

---

## Referencia rápida de WCAG 2.2 (Nivel AA)
...
> **Nota:** 4.1.1 Parsing está obsoleto en WCAG 2.2 (siempre satisfecho). Los problemas que cubría ahora se abordan con 1.3.1 y 4.1.2.

> **Nuevos criterios AAA en 2.2** (no requeridos para AA, pero recomendados): 2.4.12 Focus Not Obscured (Enhanced), 2.4.13 Focus Appearance, 3.3.9 Accessible Authentication (Enhanced).

> **Mirando hacia adelante:** WCAG 3.0 (W3C Accessibility Guidelines) está en borrador de trabajo (marzo de 2026). Sustituye el enfoque de aprobado/reprobado por conformidad Bronze/Silver/Gold y usa "Outcomes" en lugar de "Success Criteria". Aún NO es un estándar: continúa apuntando a WCAG 2.2 AA.

## Contexto legal de cumplimiento (2026)

- **European Accessibility Act (EAA)**: En vigor desde junio de 2025 en los 27 estados miembros de la UE. Aplica a productos y servicios digitales. Multas de hasta 3 millones de EUR. Hace referencia a EN 301 549 (alineado con WCAG 2.1 AA).
- **ADA Title II (US)**: Regla de accesibilidad digital vigente desde abril de 2026 para gobiernos estatales/locales que atienden a más de 50.000 personas (abril de 2027 para entidades más pequeñas). Requiere WCAG 2.1 AA.
- **Section 508 (US Federal)**: Hace referencia a WCAG 2.0 AA (se espera actualización a 2.1/2.2).

**Objetivo**: WCAG 2.2 AA cubre todos los requisitos legales actuales (superconjunto de 2.1 AA y 2.0 AA).

---

## Cinco reglas de ARIA
...
## Referencia de interacción por teclado
...
### Patrones específicos de widgets
...
## Referencia rápida de contraste de color
...
## Lista de verificación de accesibilidad (POUR)
